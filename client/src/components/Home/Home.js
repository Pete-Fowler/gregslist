  ...
  return (
    <div className={styles.home}>
      ...
      <div className={styles.leftBar}>
        ...
        <br></br>
        <Link to={postPath} className={styles.posting}>
          create a posting
        </Link>
        ...
        <table className={styles.table}>
          <tbody>
            ...
            <tr className={styles.tableRow}>
              ...
              <td className={styles.tableDateCurrent}>
                <a href="">28</a>
              </td>
        ...
        <div className={styles.mainContentBox}>
          <div className={styles.col1}>
            <div className={`${styles.section} ${styles.community}`}>
              <Link className={styles.heading} to="/search/community">
                community
              </Link>
              {renderLinks(communityCategories)}
            </div>
            <div className={`${styles.section} ${styles.services}`}>
              <Link className={styles.heading} to="/search/services">
                services
              </Link>
          ...
          <div className={styles.col2}>
            <div className={`${styles.section} ${styles.housing}`}>
              <Link className={styles.heading} to="/search/housing">
                housing
              </Link>
              {renderLinks(housingCategories, styles.housingLinks)}
            </div>
            <div className={`${styles.section} ${styles.forSale}`}>
              <Link className={styles.heading} to="/search/for sale">
                for sale
              </Link>
          ...
          <div className={styles.col3}>
            <div className={`${styles.section} ${styles.jobs}`}>
              <Link className={styles.heading} to="/search/jobs">
                jobs
              </Link>
      ...
      <div className={styles.rightBar}>
        ...
        {cities.map((city) => (
          <Cities key={city.id} id={city.id} name={city.name} />
        ))}
  ...
  return (
    <div className={styles.subcategoryBox}>
      {categories.map((category) => (
        <Link
          key={category}
          className={`${styles.subcategory} ${classParam}`}
          to={`/search/${category}`}
        >
          {category}
        </Link>
