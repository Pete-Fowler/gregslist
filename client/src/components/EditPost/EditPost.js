    ...
    <div className={styles.post}>
      ...
      >
        ...
        <select
          ...
          onChange={selectCat}
          value={patch > 0 ? cat : postObject.category}
        >
        ...
        <div className={styles.groupcontainer}>
          <label for="postingtitle" className={styles.postlabel}>
            ...
            <input
              ...
              value={patch > 0 ? title : postObject.title}
            />
          </label>
          <label for="price" className={styles.pricelabel}>
            ...
            <input
              ...
              value={patch > 0 ? price : postObject.price}
            />
          </label>
          <label for="cityorneighborhood" className={styles.citylabel}>
            ...
            <input
              ...
              onChange={handleCity}
              value={patch > 0 ? city : postObject.area}
            />
          </label>
          <label for="postalcode" className={styles.postallabel}>
            ...
            <input
              ...
              value={patch > 0 ? postal : postObject.postal_code}
            />
          </label>
        </div>
        <div className={styles.descriptioncontainer}>
          <label htmlFor="description" className={styles.descriptionlabel}>
            ...
            <textarea
              ...
              value={patch > 0 ? description : postObject.description}
            ></textarea>
          </label>
        </div>
        ...
        {addImage ? (
          <label for="imageInput" className={styles.imagelabel}>
            ...
            <input
              ...
              value={patch > 0 ? image : postObject.image}
            />
          </label>
        ) : (
